...
<body>
    ...
    <main class="container pt-5">
        ...
        <form method="POST" action="{{url('update',$etudiant->id)}}">
            {{method_field('PUT')}}
            @csrf 
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nom" class="form-control" id="exampleInputText1" value="{{$etudiant->nom}}">
            </div>

            <div class="mb-3">
                <label for="exampleInputText1" class="form-label">Prénom</label>
                <input type="text" name="prenom" class="form-control" id="exampleInputText1" value="{{$etudiant->prenom}}">
            </div>

            <div class="mb-3">
                <label for="exampleInputText1" class="form-label">Âge</label>
                <input type="number" name="age" class="form-control" id="exampleInputText1" value="{{$etudiant->age}}">
            </div>

            <div class="mb-3">
                <label for="exampleInputText1" class="form-label">Classe</label>
                <input type="text" name="classe" class="form-control" id="exampleInputText1" value="{{$etudiant->classe}}">
            </div>
